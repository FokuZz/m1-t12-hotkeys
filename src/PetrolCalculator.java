...
public class PetrolCalculator {
    public void calculateLoop() {
        ...
        for (int counter = 0; counter < iterationsCount; counter++) {
            ...
            double voulme = scanner.nextDouble();
            if (petrolType == 1) {
                double price = new Ai92Calculator().calculate(voulme);
                System.out.println("Стоимость " + voulme + " литров АИ-92 = " + price + "₽");
            } else if (petrolType == 2) {
                double price = new Ai95Calculator().calculate(voulme);
                System.out.println("Стоимость " + voulme + " литров АИ-95 = " + price + "₽");
            }
        }
    }
